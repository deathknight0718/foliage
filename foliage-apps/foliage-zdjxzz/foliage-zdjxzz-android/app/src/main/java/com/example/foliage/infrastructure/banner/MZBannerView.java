package com.example.foliage.infrastructure.banner;
...
import com.example.foliage.infrastructure.banner.transformer.CustomTransformer;
import com.example.foliage.infrastructure.utils.ScreenUtil;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private RelativeLayout mIndicatorParent;//indicator父容器
    ...
    private void init() {
        ...
        mIndicatorParent = (RelativeLayout) view.findViewById(R.id.banner_indicator_parent);
    ...
    public void setIndicatorHeight(int height) {
        LayoutParams layoutParams = (LayoutParams) mIndicatorParent.getLayoutParams();
        layoutParams.setMargins(0, 0, 0, ScreenUtil.dp2px(height));
        mIndicatorParent.setLayoutParams(layoutParams);
    }
