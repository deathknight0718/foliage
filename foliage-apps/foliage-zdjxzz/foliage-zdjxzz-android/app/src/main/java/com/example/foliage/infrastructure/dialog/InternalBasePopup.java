...
/**
 * Description：Base class to help create PopupWindow Style Dialog(实现PopupWindow风格对话框基类)
 * Created by liang.qfzc@gmail.com on 2018/7/26.
 */
...
public abstract class InternalBasePopup<T extends InternalBasePopup<T>> extends BaseDialog<T> {
    ...
    public T location(int x, int y) {
        mX = x;
        mY = y - mContext.getResources().getDisplayMetrics().heightPixels;
        return (T) this;
    }
}
