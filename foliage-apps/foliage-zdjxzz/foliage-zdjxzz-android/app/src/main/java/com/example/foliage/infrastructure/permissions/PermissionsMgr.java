...
package com.example.foliage.infrastructure.permissions;
...
/**
 * Description : 权限管理类 Created by wxh on 2016/3/10 16:14. Job number：138746
...
public class PermissionsMgr {
     ...
     * 校验缺少的权限
     */
    public synchronized String checkPermissions(@Nullable Context context,
                                                  @NonNull String[] permissions) {
        if (context == null) {
            return PermissionsConstant.WRITE_STORAGE;
        }
        for (String perm : permissions) {
