...
import com.example.foliage.infrastructure.dialog.interfaces.OnBtnClickL;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
     ...
     */
    protected int mLeftBtnTextColor = Color.parseColor("#FF3F40");
    protected int mRightBtnTextColor = Color.parseColor("#FF3F40");
    protected int mMiddleBtnTextColor = Color.parseColor("#FF3F40");
    /**
     * btn textsize(按钮字体大小)
     */
