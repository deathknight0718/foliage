...
public class FederatedIdentityService extends IdmIdentityServiceImpl {
    ...
    public static class LdapGroup extends AbstractIdmEngineEntity implements GroupEntity, Serializable {
    ...
    public static class LdapUser extends AbstractIdmEngineEntity implements UserEntity, Serializable, HasRevision {
