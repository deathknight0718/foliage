 ...
 */
public class DomainProcessSubmit extends FlowCommandDelegate implements JavaDelegate {
    ...
    protected void doExecute(FlowExecution execution) {
        ...
        FlowDefinition definition = singleton().definitionQueryByKeyAndDomain(definitionKey, domain);
        ...
        FlowProcess.Builder starter = definition.starter();
