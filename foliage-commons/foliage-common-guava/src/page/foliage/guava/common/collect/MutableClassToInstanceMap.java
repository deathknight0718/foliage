...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    public void putAll(Map<? extends Class<? extends B>, ? extends B> map) {
        ...
        for (Entry<? extends Class<? extends B>, B> entry : copy.entrySet()) {
            // TODO(deathknight0718@qq.com): https://bugs.openjdk.java.net/browse/JDK-8054721
            // TODO(deathknight0718@qq.com): https://bugs.eclipse.org/bugs/show_bug.cgi?id=448793
    ...
    @CanIgnoreReturnValue
    private static <S, T extends S> T cast(Class<T> type, S value) {
