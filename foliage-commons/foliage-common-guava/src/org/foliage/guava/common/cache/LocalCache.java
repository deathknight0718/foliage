...
package org.foliage.guava.common.cache;

import static java.util.concurrent.TimeUnit.NANOSECONDS;
import static org.foliage.guava.common.base.Preconditions.checkNotNull;
import static org.foliage.guava.common.base.Preconditions.checkState;
import static org.foliage.guava.common.cache.CacheBuilder.NULL_TICKER;
import static org.foliage.guava.common.cache.CacheBuilder.UNSET_INT;
import static org.foliage.guava.common.util.concurrent.Futures.transform;
import static org.foliage.guava.common.util.concurrent.MoreExecutors.directExecutor;
import static org.foliage.guava.common.util.concurrent.Uninterruptibles.getUninterruptibly;
...
import org.foliage.guava.common.annotations.VisibleForTesting;
import org.foliage.guava.common.base.Equivalence;
import org.foliage.guava.common.base.Stopwatch;
import org.foliage.guava.common.base.Ticker;
import org.foliage.guava.common.cache.AbstractCache.SimpleStatsCounter;
import org.foliage.guava.common.cache.AbstractCache.StatsCounter;
import org.foliage.guava.common.cache.CacheBuilder.NullListener;
import org.foliage.guava.common.cache.CacheBuilder.OneWeigher;
import org.foliage.guava.common.cache.CacheLoader.InvalidCacheLoadException;
import org.foliage.guava.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import org.foliage.guava.common.cache.LocalCache.AbstractCacheSet;
import org.foliage.guava.common.collect.AbstractSequentialIterator;
import org.foliage.guava.common.collect.ImmutableMap;
import org.foliage.guava.common.collect.ImmutableSet;
import org.foliage.guava.common.collect.Iterators;
import org.foliage.guava.common.collect.Maps;
import org.foliage.guava.common.collect.Sets;
import org.foliage.guava.common.primitives.Ints;
import org.foliage.guava.common.util.concurrent.ExecutionError;
import org.foliage.guava.common.util.concurrent.Futures;
import org.foliage.guava.common.util.concurrent.ListenableFuture;
import org.foliage.guava.common.util.concurrent.SettableFuture;
import org.foliage.guava.common.util.concurrent.UncheckedExecutionException;
import org.foliage.guava.common.util.concurrent.Uninterruptibles;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code org.foliage.guava.common.collect.MapMaker})
  ...
  static class LoadingValueReference<K, V> implements ValueReference<K, V> {
    ...
    public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
      try {
        ...
        return transform(
            newValue,
            new org.foliage.guava.common.base.Function<V, V>() {
              @Override
