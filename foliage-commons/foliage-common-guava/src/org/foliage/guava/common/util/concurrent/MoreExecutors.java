...
import org.foliage.guava.common.collect.Queues;
import org.foliage.guava.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory)
          Class.forName("org.foliage.guava.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngine() {
    if (System.getProperty("org.foliage.guava.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("org.foliage.guava.apphosting.api.ApiProxy")
